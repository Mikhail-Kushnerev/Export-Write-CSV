...
в файле **load_data_csv.py**, с 26 – 30 строку указать [**ВСЕ**](#1) поля для экспорта.
...
запустить скрипт **management.py**, с 22 –  строку указать [**ВСЕ**](#1) поля для экспорта. Также
<a name="1"/>
___
